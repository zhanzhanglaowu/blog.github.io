		...
		*/
		...
		render:function(){ //v2增加
			...
			if(document.getElementById(translate.selectLanguageTag.documentId) == null){
				...
				var text2 = document.createTextNode("切换语言：");
	...
	*/
	...
	language:{
		...
		*/
		...
		//比如当前语种是简体中文，网页url是http://translate.zvo.cn/ ,那么可以通过在url后面增加 language 参数指定翻译语种，来使网页内容以英文形态显示 http://translate.zvo.cn/?language=english
